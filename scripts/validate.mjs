...
const requiredFiles = ['index.html', 'tokens.css', 'garden.css', 'styles.css', 'app.js', 'plan-data.js', 'nico-plan.js', 'duolingo-data.json', 'scripts/fetch-duolingo.mjs', '404.html', 'favicon.svg', 'assets/reading.svg', 'assets/plant.svg', 'ASSET-LICENSES.md'];
